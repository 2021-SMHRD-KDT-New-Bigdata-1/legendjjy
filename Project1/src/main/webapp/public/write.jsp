						...
						<td style=" border: 1px solid silver; border-radius: 20px;">
							<form action="write.jsp" method="post"
								...
								허용 <input type="checkbox" value=""
								    ...
								    <button class="btn btn-default" style="margin-right: 20px; border: none; font-size: 20px; color: black;
								     background: rgb(249, 208, 35); box-shadow: 3px 3px 3px silver;">글 삭제</button>
    
    								<button type="submit" class="btn btn-default" style="border: none; font-size: 20px; color: black;
    								 background: rgb(249, 208, 35); box-shadow: 3px 3px 3px silver;">수정완료</button>
