...
<meta name="msapplication-TileImage"
	content="../public/assets/img/favicons/mstile-150x150.png">
...
<link href="../public/vendors/swiper/swiper-bundle.min.css"
	rel="stylesheet">
...
<body data-bs-spy="scroll" data-bs-target="#navbar">
	...
	<main class="main" id="top">
		<nav
			...
			<div class="container">
				<a class="navbar-brand d-inline-flex" href="../public/index.jsp"><img
					class="card-img" src="../public/assets/img/gallery/logo_small.png"
					alt="..." /><span class="fs-2 fw-bold text-primary ms-2">LEGEN<span
				...
				<div
					...
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0" id="main-menu">
						...
						<li class="nav-item px-2"><a class="nav-link fw-bold"
							href="<%if (vo == null) {%>../public/Login_v2/login.jsp<%} else {%>../public/loveIt.jsp<%}%>">스크랩
								목록</a></li>
						<li class="nav-item px-2"><a class="nav-link fw-bold"
							href="<%if (vo == null) {%>../public/Login_v2/login.jsp<%} else {%>../public/follow/follow.jsp<%}%>">구독
								목록</a></li>
						<li class="nav-item px-2"><a class="nav-link fw-bold"
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu fw-bold"
								...
								<li><a class="dropdown-item fw-bold"
									href="../public/profile.jsp">내 프로필</a></li>
								<li><a class="dropdown-item fw-bold"
									href="../public/Login_v2/edit.html">개인정보수정</a></li>
								<li><a class="dropdown-item fw-bold"
									href="../public/index.jsp">로그아웃</a></li>
							</ul></li>
						<%
		...
		<form style="text-align: center;">
			...
			%>
			<a href="../public/publish_admin/appli.jsp"><input type="button" value="조회하기"
				style="width: 150px; height: 60px; margin-top: 100px; font-size: 20px; color: cornsilk; background-color: rgb(69, 100, 177); border: 2"
				data-aos="fade-up" data-aos-duration="2000"></a>
			<%
			}
		...
		<div style="text-align: center; margin-top: 200px;">
			<img src="imgs/designed_01.png" alt=""
				style="margin-bottom: 30px; margin-right: 0;"> <img
